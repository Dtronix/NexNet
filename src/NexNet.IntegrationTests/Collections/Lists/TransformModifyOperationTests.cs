...
[TestFixture]
public class TransformModifyOperationTests
{
    ...
    {
        var txOp = new ModifyOperation<int>(1, 1);

        Assert.Multiple(() =>
        {
            var list = new VersionedList<int>().FillNegative(3);
            list.ProcessOperation(txOp, 0, out _);
            Assert.That(list, Is.EqualTo(new[] { -1, 1, -3 }));
        });
    }
    ...
    {
        var txOp = new ModifyOperation<int>(2, 1);
    ...
    public void Instancing_Throws_OnIndexUnderflow()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => new ModifyOperation<int>(-1, 1));
    }
    ...
    public void OperationAfterInsert_AtSameIndex_ShiftsIndexUp()
    {
        ...
        var txOp = new ModifyOperation<int>(1, 2);
    ...
    {
        var history = new InsertOperation<int>(1, 1);
        var txOp = new ModifyOperation<int>(0, 2);
        var listOp = txOp.Clone();
        ...
        Assert.Multiple(() =>
        {
            ...
            list.ProcessOperation(history, 0, out _);
            Assert.That(list.ProcessOperation(listOp, 0, out _), Is.EqualTo(txOp));
            Assert.That(list, Is.EqualTo(new[] { 2, 1, -2}));
        });
    }
    ...
    public void OperationAfterMove_FromClientIndexMoveToDestination()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            list.ProcessOperation(history, 0, out _);
            Assert.That(list.ProcessOperation(listOp, 0, out _), Is.EqualTo(txOp));
            Assert.That(list, Is.EqualTo(new[] { -2, -3, 1, -4 }));
        });
    }
    ...
    public void OperationAfterMove_ToClientIndexShiftUpIndex()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            list.ProcessOperation(history, 0, out _);
            Assert.That(list.ProcessOperation(listOp, 0, out _), Is.EqualTo(txOp));
            Assert.That(list, Is.EqualTo(new[] { -3, 1, -2, -4 }));
        });
    }
    ...
    public void OperationAfterMove_RightwardShift_ShiftsIndexDown()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            list.ProcessOperation(history, 0, out _);
            Assert.That(list.ProcessOperation(listOp, 0, out _), Is.EqualTo(txOp));
            Assert.That(list, Is.EqualTo(new[] { -1, 1, -4, -2 }));
        });
    }
    ...
    public void OperationAfterMove_LeftwardShift_ShiftsIndexUp()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            list.ProcessOperation(history, 0, out _);
            Assert.That(list.ProcessOperation(listOp, 0, out _), Is.EqualTo(txOp));
            Assert.That(list, Is.EqualTo(new[] { -1, -4, -2, 1, -5 }));
        });
    }
    ...
    public void OperationAfterMove_MoveRight_InsertIndexBetweenBounds_ShiftsIndexDown()
    {
        ...
        var txOp = new ModifyOperation<int>(3, 1);
        var listOp = txOp.Clone();
        ...
        Assert.Multiple(() =>
        {
            ...
            var list = new VersionedList<int>().FillNegative(6);
            list.ProcessOperation(history, 0, out _);
            Assert.That(list.ProcessOperation(listOp, 0, out _), Is.EqualTo(txOp));
            Assert.That(list, Is.EqualTo(new[] { -1, -3, 1, -5, -2, -6}));
        });
    }
    ...
    public void OperationAfterMove_MoveLeft_InsertIndexBetweenBounds_ShiftsIndexUp()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            list.ProcessOperation(history, 0, out _);
            Assert.That(list.ProcessOperation(listOp, 0, out _), Is.EqualTo(txOp));
            Assert.That(list, Is.EqualTo(new[] {-1, -5, -2, -3, 1, -6}));
        });
    }
    ...
    {
        var history = new ModifyOperation<int>(2, 2);
        var txOp = new ModifyOperation<int>(1, 1);
        var listOp = txOp.Clone();
        ...
        Assert.Multiple(() =>
        {
            ...
            list.ProcessOperation(history, 0, out _);
            Assert.That(list.ProcessOperation(listOp, 0, out _), Is.EqualTo(txOp));
            Assert.That(list, Is.EqualTo(new[] { -1, 1, 2, -4 }));
        });
    }
}
