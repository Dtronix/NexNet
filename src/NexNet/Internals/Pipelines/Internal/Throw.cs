...
namespace NexNet.Internals.Pipelines.Internal;
...
internal static class Throw
{
    ...
    internal static void SegmentDataUnavailable()
        => InvalidOperation("The segment data was not available");

    internal static void AllocationDuringEnumeration()
        => InvalidOperation("Data was allocated while the enumerator was iterating");
}
