...
#pragma warning restore RCS1163 // Unused parameter.
    ...
    {
        var err = GetAssemblyFailureMessage();
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    private static void CheckUnsafe() => _ = Unsafe.SizeOf<int>();
...
#pragma warning disable RCS1231 // Make parameter ref read-only.
    internal static ArraySegment<byte> GetArray(this Memory<byte> buffer) => ((ReadOnlyMemory<byte>)buffer).GetArray();
    internal static ArraySegment<byte> GetArray(this ReadOnlyMemory<byte> buffer)
#pragma warning restore RCS1231 // Make parameter ref read-only.
    {
        if (!MemoryMarshal.TryGetArray(buffer, out var segment)) Throw.InvalidOperation("MemoryMarshal.TryGetArray<byte> could not provide an array");
        return segment;
    }
