...
#pragma warning restore RCS1231
    ...
    {
        if (!source.TryCopyTo(destination, projection))
...
#pragma warning restore RCS1231
    ...
    {
        if (!source.TryCopyTo(destination, projection, in state))
            Throw.InvalidOperation();
    }
...
#pragma warning restore RCS1231
    ...
    {
        if (!source.TryCopyTo(in destination))
            Throw.InvalidOperation();
    }
...
#pragma warning restore RCS1231
    ...
    {
        if (!source.TryCopyTo(in destination, projection))
            Throw.InvalidOperation();
    }
...
#pragma warning restore RCS1231
    ...
    {
        if (!source.TryCopyTo(in destination, projection, in state))
            Throw.InvalidOperation();
    }
...
#pragma warning restore RCS1231
    ...
    {
        if (!source.TryCopyTo(destination)) Throw.InvalidOperation();
    }
...
#pragma warning restore RCS1233 // Use short-circuiting operator.
    ...
    {
        if (!source.TryCopyTo(destination, projection)) Throw.InvalidOperation();
    }
    ...
    public static bool TryCopyTo<TFrom, TTo>(this in Sequence<TFrom> source, in Sequence<TTo> destination, Projection<TFrom, TTo> projection)
    {
        ...
        SlowCopyTo(source, destination, projection);
        return true; // we checked the lengths first
    }
    ...
    public static void CopyTo<TFrom, TState, TTo>(this in Sequence<TFrom> source, in Sequence<TTo> destination,
        Projection<TFrom, TState, TTo> projection, in TState state)
    {
        if (!source.TryCopyTo(destination, projection, in state)) Throw.InvalidOperation();
    }
        ...
        Projection<TFrom, TState, TTo> projection, in TState state)
    {
        ...
        SlowCopyTo(source, destination, projection, in state);
        return true; // we checked the lengths first
    }
